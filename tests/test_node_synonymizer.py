...
"""
Usage:
    Run all tests: pytest -v tests/test_node_synonymizer.py
    Run a single test: pytest -v tests/test_node_synonymizer.py -k test_example_9
"""
import copy
import json
import timeit
...
if __name__ == "__main__":
    pytest.main(['-v', 'tests/test_node_synonymizer.py'])
